...
- **Direct-Cypher xfail contract**: Reclassified `match-where3-3` from validation-fail default to `success_matches_expected` to reflect current sibling-target execution behavior.
