...
- **Row-pipeline lane contracts**: Added tranche-14 TCK-only guardrails for `#43` (String8 + String9 expression residual clusters) and raised row-pipeline coverage floor to `140`.
