...
- **Direct-Cypher xfail contract**: Updated sibling-target drift snapshot for `with5-2` from `GFQLValidationError` to `success_matches_expected` after pygraphistry #1488 bounded connected OPTIONAL MATCH materialization.
