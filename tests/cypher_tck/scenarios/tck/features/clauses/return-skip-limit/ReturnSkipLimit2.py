...
SCENARIOS = [
    Scenario(
        ...
        gfql=plan(
            step("unwind", expr="[1, 1, 1, 1, 1]", as_="i"),
            select([("i", "i")]),
            limit(2),
        ),
        status="xfail",
    ...
    Scenario(
        ...
        gfql=plan(
            match(n({"label__A": True}, name="a"), e_forward(), n(name="n"), e_forward(), n(name="m")),
            rows(table="nodes", source="n"),
            group_by(["n.num"]),
            select([("n.num", "n.num"), ("count(*)", "count(*)")]),
            order_by([("n.num", "asc")]),
            limit(1000),
        ),
        status="xfail",
    ...
    Scenario(
        ...
        gfql=plan(
            ...
            select([("n", "n")]),
            limit("n.count"),
            step("invalid", note="LIMIT expression depends on variables"),
        ),
        status="xfail",
    ...
    Scenario(
        ...
        gfql=plan(
            ...
            select([("name", "p.name")]),
            limit("$_limit"),
            step("invalid", note="negative LIMIT parameter"),
        ),
        status="xfail",
    ...
    Scenario(
        ...
        gfql=plan(
            ...
            select([("n", "n")]),
            limit(-1),
            step("invalid", note="negative LIMIT"),
        ),
        status="xfail",
    ...
    Scenario(
        ...
        gfql=plan(
            ...
            select([("name", "p.name")]),
            limit("$_limit"),
            step("invalid", note="non-integer LIMIT parameter"),
        ),
        status="xfail",
        reason="Parameter binding and runtime validation for LIMIT are not supported",
        tags=("return", "limit", "params", "runtime-error", "xfail"),
    ...
    Scenario(
        ...
        gfql=plan(
            ...
            select([("n", "n")]),
            limit(1.7),
            step("invalid", note="non-integer LIMIT literal"),
        ),
        status="xfail",
        reason="Compile-time validation for LIMIT arguments is not enforced",
        tags=("return", "limit", "syntax-error", "xfail"),
