...
PRIMARY_FAMILY_DEFINITIONS: Tuple[PriorityLaneDefinition, ...] = (
    ...
    PriorityLaneDefinition(
        ...
        architecture_risk="high",
        tracker_ref="#51",
        tracker_url="https://github.com/graphistry/tck-gfql/issues/51",
    ...
    PriorityLaneDefinition(
        ...
        architecture_risk="high",
        tracker_ref="#54",
        tracker_url="https://github.com/graphistry/tck-gfql/issues/54",
    ...
    PriorityLaneDefinition(
        ...
        architecture_risk="high",
        tracker_ref="#53",
        tracker_url="https://github.com/graphistry/tck-gfql/issues/53",
    ...
    PriorityLaneDefinition(
        ...
        architecture_risk="medium",
        tracker_ref="#52",
        tracker_url="https://github.com/graphistry/tck-gfql/issues/52",
